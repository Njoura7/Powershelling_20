...
# Define the user for 'user19'
$userName19 = "user19"

# Get the name of a firewall rule with a specific property
$firewallRule = Get-NetFirewallRule | Where-Object { $_.Direction -eq 'Inbound' -and $_.Action -eq 'Allow' } | Select-Object -First 1
#$password19 = $firewallRule.Name
$password19="test"
# Convert the password to a secure string
$securePassword19 = ConvertTo-SecureString $password19 -AsPlainText -Force

# Create the new local user 'user19'
Set-LocalUser -Name $userName19 -Password $securePassword19

# Get Readme file
$Readme = (Get-Content -Path "C:\Users\user18\Desktop\README.txt" -Raw).Trim()
